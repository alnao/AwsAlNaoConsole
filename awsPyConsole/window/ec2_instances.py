...
class Ec2InstanceWindow:
    ...
    def crea_window(self):
        ...
        self.frame2 = ttk.Frame(self.frame, width=350, height=630)
    ...
    def open_detail(self, event): #(frame,profilo,lista_istanze,istanza):
        ...
        self.tree2.column("Chiave", width=150)
        self.tree2.column("Valore",anchor=CENTER,width=180)
        ...
        self.tree3.column("Valore",anchor=CENTER,width=180)
