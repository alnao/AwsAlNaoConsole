...
#
class SsmParameterInstanceWindow:
    def __init__(self,frame,profilo,lista_parametri,crea_parametro,reload_method):
        self.lista_parametri=lista_parametri
        self.profilo=profilo
        self.frame=frame
        self.distribuzione={}
        self.id=''
        self.crea_parametro=crea_parametro
    ...
    def send_creation(self):        
        ...
        self.crea_parametro(self.profilo, self.e1.get(), self.e2.get() , "String" , self.e1.get() )
