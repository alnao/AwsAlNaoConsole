...
class DynamoDBInstanceWindow:
    def __init__(self,frame,profilo,lista_tabelle,lista_elementi,put_element,delete_element,reload_method,to_clipboard):
        self.profilo=profilo
        self.frame=frame
        self.distribuzione={}
        self.id=''
        self.lista_tabelle=lista_tabelle
        self.lista_elementi=lista_elementi
        self.put_element=put_element
    ...
    def open_detail(self, event): #(frame,profilo,lista_istanze,istanza):
        ...
        self.lista_elementi_return = self.lista_elementi(self.profilo,self.tabella_sel)
    ...
    def window_modifica_save_item(self):
        ...
        self.put_element ( self.profilo,self.tabella_sel, elemento)  #(profile_name, table,element):
